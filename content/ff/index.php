...
<div class="container">
 <div class="sidebar">
  ...
  <a class="logo-expand" href="#">OmniSup</a>
 ...
 <div class="wrapper">
  ...
  <div class="main-container">
   <div class="main-header anim" style="--delay: 0s">Découvrez</div>
   <div class="main-blogs">
    <div class="main-blog anim" style="--delay: .1s">
     <div class="main-blog__title">Programme comme un Pro!</div>
     <div class="main-blog__author">
      ...
      <div class="author-detail">
       ...
       <div class="author-info"><span class="seperate"></span>15/04/23</div>
      </div>
     </div>
     <div class="main-blog__time">15 min</div>
    </div>
   ...
   <div class="small-header anim" style="--delay: .3s">Recomandation</div>
   <div class="videos">
