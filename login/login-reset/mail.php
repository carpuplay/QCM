...
if (isset($_POST["mail"]) && ($_POST["mail"]!="") )
{
    ...
    if ($existe) 
    {
        ...
        <body>
          <div class='container'>
            ...
            <a href='./mail2.php?id=$id&code=$code&t=$time'>Réinitialiser mon mot de passe</a>
                <!-- <a href='https://nsi.exonstudio.com/login/login-reset/mail2.php?id=$id&code=$code&t=$time'>Réinitialiser mon mot de passe</a> -->
            </p>
        ...
        print($message); //eliminar para servidor
        //mail( $to, $subject, $message, $headers); habilitar en servidor
