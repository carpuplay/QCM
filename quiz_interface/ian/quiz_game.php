...
foreach  ($questions as $question)
 ...
 if ($type=="solo")
 {
  $une_question = file_get_contents('solo.html');
 }
 else
 {
    $une_question = file_get_contents('multi.html');
 }
  ...
  $p="p_$id";
  $une_question=str_replace("p0",$p,$une_question);
  $les_questions=$les_questions.$une_question;
  //print($les_questions);
  }
  //print($les_questions);

  $la_page = file_get_contents('quiz_game.html');
